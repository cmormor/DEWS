...
public class EmpresaDAO {
	...
	public int getSalarioByDni(String dni) throws SQLException, DatosNoCorrectosException {
		...
		try (Connection con = DBConnection.getConnection(); PreparedStatement ps = con.prepareStatement(consulta)) {
			ps.setString(1, dni);
	...
	public List<Empleado> buscarEmpleados(String dni, String nombre, String sexo, String categoria, String anyos)
		...
		try (Connection con = DBConnection.getConnection();
			...
			if (empleados.isEmpty()) {
				throw new DatosNoCorrectosException("No se encontraron empleados con los datos proporcionados.");
			}
